...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    className={cn(
      "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-drawer bg-black/50 backdrop-blur-xs",
      className,
    )}
    {...props}
  />
